...
# Python str 내부는 유니코드이므로 저장 자체에는 영향 없음.
...
app.include_router(guidelines_v3.router, prefix="/api/guidelines/v3", tags=["실무지침 v3(자격중심)"])
...
app.include_router(self_check.router,     prefix="/api/self-check",               tags=["공통기준 자가점검"])
